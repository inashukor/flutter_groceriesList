...
import 'package:mecommerce/screen/signup.dart';
...
////////////////////firebase messaging/////////////
  ...
  void cekEmail(String email) async {
    ...
    if (value == 1) {
      setState(() {
        savePref(id, emailUsers, phone, name, createdDate, level);
      });
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => Signup(email, fcmToken)));
    }
  }
